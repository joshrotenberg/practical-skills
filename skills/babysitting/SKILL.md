...
- Emergency contact information for the parents, written down (not just in your phone — your phone may be dead, lost, or currently being used by a 4-year-old to watch Bluey)
- Address of the residence, for giving to 911 if necessary
- Knowledge of any allergies (food, medication, environmental). Ask the parents explicitly. Then ask again.
- Location of: first aid kit, fire extinguisher, flashlight, and fuse box
- Familiarity with all door locks and window locks
- Snacks, pre-approved by parents. Do not introduce new foods — an allergic reaction during babysitting is a medical emergency and a conversation you do not want to have.
- Age-appropriate entertainment: books, coloring supplies, board games, one (1) approved screen option as a last resort
...
- Telling the child "your parents will be home soon" when you don't know that. If bedtime is 8:00 and the parents said they'd be home by 11:00, the child does not need to know the timeline. "They'll be home after you're asleep" is sufficient and avoids hourly check-ins.
- Using screen time as a first resort. It works. It works so well that when you need to take it away, the transition is catastrophic. Use it strategically and briefly, not as the default activity.
- Not childproofing your behavior. If you leave your bag on the floor, a toddler will find it and distribute its contents throughout the house. Medications, keys, pens, and coins will be located and investigated. Put your things out of reach.
- Assuming older children don't need supervision. A 7-year-old left alone in a room for 10 minutes can construct a situation that requires professional intervention. Check in regularly.
