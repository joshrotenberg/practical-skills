...
- Adjustable wrench (10") and channel-lock pliers (12")
- Pipe wrench (14") for threaded connections
- Basin wrench for faucet supply nuts in tight spaces
- Tube cutter for copper; PEX crimper or expansion tool for PEX
- Teflon tape (yellow for gas, white for water) and pipe dope
- Bucket and towels. Always have a bucket and towels.
- Headlamp. Under-sink work requires both hands and the ability to see.

## Leak Repair: Copper Supply Line
...
- Forgetting to drain the line before soldering. Water in the pipe will prevent the joint from reaching temperature. Even a slow drip is enough. Stuff a piece of white bread into the pipe upstream — it absorbs the residual water and dissolves when you restore flow.
- Overtightening compression fittings. They seal with a brass ferrule that deforms onto the pipe. A quarter turn past finger-tight is sufficient. If it leaks, tighten another quarter turn. Do not crank it.
- Using the wrong Teflon tape direction. Wrap clockwise as viewed from the threaded end, so the tape tightens as you thread the fitting on, not bunches up.
- Not supporting the pipe when tightening a fitting. Always use a backup wrench on the pipe or fitting you're tightening against. Otherwise you will stress a joint somewhere else in the line and create a new leak.
