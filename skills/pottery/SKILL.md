...
- Potter's wheel (electric kick wheel, 1/2 HP minimum). Set it at a comfortable height — your elbows should be roughly level with the wheel head when seated.
- Clay body appropriate to your firing temperature. For beginners, a mid-fire stoneware (cone 5–6) with some grog (ground fired clay particles mixed into the body for strength and texture) is forgiving and versatile. A 25-lb bag is enough for a dozen small forms.
- Bat pins and bats (round boards that attach to the wheel head for easy removal of finished pieces)
- Wire clay cutter (a twisted wire with two toggles)
...
- Fighting the wheel. If the clay is off-center, applying more force in a random direction makes it worse. Stop, recenter deliberately with anchored elbows and steady pressure, then continue. The wheel is stronger than you are — work with the rotation, not against it.
- Throwing with dry hands. Friction between dry skin and spinning clay tears the surface and pulls the form off-center. Keep your hands wet. Not dripping — a thin film of water is sufficient. Too much water weakens the clay.
- Pulling too fast. The instinct is to yank the wall up quickly. Fast pulls tear the clay or create thin spots. A slow, steady pull with even pressure does more work and produces a more uniform wall.
- Neglecting compression. Every joint, every floor, every rim needs to be compressed. Uncompressed clay dries unevenly and cracks. Press the floor flat with a rib after opening. Compress the rim after every pull.
- Drying unevenly. If the rim of a pot dries faster than the base (common in dry studios), the rim shrinks first and cracks. Cover pots loosely with plastic and dry slowly. A pot that takes three days to reach leather-hard will crack less than one that dries in six hours.
