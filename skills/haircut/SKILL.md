...
- Clippers with a full set of guards: 0 (no guard), 1 (1/8"), 1.5 (3/16"), 2 (1/4"), 3 (3/8"), 4 (1/2")
- Adjustable clipper lever (most professional clippers have a taper lever on the side that opens or closes the blade gap, giving half-steps between guards)
- Detachable blade set if doing skin fades: 000 (0.5mm), 00000 (0.2mm), or a foil shaver for bald skin
- Shears, 6" or 7", convex edge for slide cutting
- Thinning shears (texturizing shears) with 30–40 teeth
- Barber comb (tapered, with fine and wide teeth) and a cutting comb
- Spray bottle with water
- Cape, neck strip, and a hand mirror for the back
- Good overhead lighting. Shadows hide unevenness.
...
- Zone 1 (bottom): 000 to 1" above ear
- Zone 2 (middle): #1, lever closed, from hairline to about 2" above ear
- Zone 3 (upper): #1, lever open, from hairline to where the head starts to round (the parietal ridge)
...
- Cutting the fade line too high or too sharp on the first pass. Start conservative — you can always take more off, but you cannot put hair back. A line that's too high or too aggressive forces you to extend the fade higher to compensate, which can change the entire shape of the cut.
- Cutting curly or coily hair wet and being surprised when it springs up 1–2 inches shorter after drying. For curly hair types, cut dry or account for the spring factor by leaving extra length. A wet cut on type 4 hair is a gamble.
- Using shears on the top without tension. Hair must be held at consistent tension between your fingers while cutting. Inconsistent tension produces inconsistent length.
- Ignoring head shape. The haircut should complement the skull, not follow it blindly. A flat spot on the crown needs slightly more length. A protruding occipital bone needs the hair below it tapered tighter to minimize the bump visually.
