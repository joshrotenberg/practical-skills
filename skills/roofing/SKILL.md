...
- Extension ladder: extend at least 3 feet above the eave. Set the base at a 75° angle (1 foot out for every 4 feet up). Secure the top against lateral movement.
- Fall protection: harness, lanyard, rope grab, and a ridge anchor or temporary roof anchor rated for 5,000 lbs. Anchor into a rafter, not just through the sheathing.
- Roofing nailer (pneumatic) loaded with 1-1/4" galvanized coil nails, or a hammer and roofing nails if working by hand
- Flat pry bar for lifting shingles and removing nails
- Utility knife with hook blades for cutting shingles
- Chalk line for snapping course lines
- Matching shingles. Asphalt shingles fade and vary by lot. An exact color match on a repair is not always possible.
- Roofing cement (also called mastic or plastic cement) and a caulk gun
- Bucket and rope for hauling materials up. Do not carry materials while climbing a ladder.
...
### Step 1: Break the sealant strip
...
### Step 3: Slide out the damaged shingle and slide in the replacement
...
- Walking on a wet or frost-covered roof. Asphalt shingles have zero traction when wet. Moss-covered shingles are worse. If the roof is not completely dry, do not get on it.
- Applying roofing cement as a permanent fix over flashing or shingles. Cement is a sealant, not a structural repair. It cracks and shrinks over 2–5 years. Use it as a supplement to proper mechanical flashing, not a replacement for it.
- Not weaving shingles into existing courses. A patch that simply overlaps existing shingles without being integrated into the nail and overlap pattern will leak at the seams.
- Nailing in the wrong location. Nails placed too high don't hold the shingle below. Nails placed too low are exposed and create a leak point. Follow the manufacturer's nailing line — it is indicated on the shingle.
