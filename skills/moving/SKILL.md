...
- Moving truck appropriately sized for the load. A 2-bedroom apartment typically requires a 15-foot truck. A 3-bedroom house typically requires a 20–26-foot truck. Err on the side of larger — an underpacked truck is easier to load than two trips.
- Moving blankets (furniture pads), at least 12 for a 2-bedroom move
- Ratchet straps (4 minimum) and rope
- Dolly: a two-wheel hand truck for boxes and appliances, and a four-wheel furniture dolly for heavy flat items
- Packing tape, bubble wrap, and boxes in uniform sizes (uniform boxes stack cleanly; random sizes create an unstable load)
- Tools for disassembly: Phillips and flathead screwdrivers, Allen key set (most flat-pack furniture uses 4mm or 5mm), adjustable wrench, zip-lock bags for hardware
- Furniture sliders (plastic discs for carpet, felt pads for hardwood)
- At least one other person. Moving a sofa alone is how you herniate a disc.
...
- Not measuring doorways, stairwells, and hallways before moving day. If the couch came in through the sliding glass door that the previous owner installed, it will not fit through the front door. Measure everything. Measure twice.
- Loading the truck with frequently needed items first. Cleaning supplies, toilet paper, a box of essentials (phone charger, medications, change of clothes, coffee maker) should be loaded last so they are available first.
- Not protecting floors. Lay down Masonite sheets or cardboard runners on hardwood floors. One pass with a hand truck loaded with a washing machine will gouge a hardwood floor down to the subfloor.
- Carrying boxes with the bottom unsealed or using old, weakened boxes for heavy items. The bottom of a box carrying books will give out in a predictable and demoralizing way.
- Not labeling boxes with both contents and destination room. "Kitchen — pots and pans" is useful at unloading. "Misc" is not.
