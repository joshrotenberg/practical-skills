...
## Wound Closure: Simple Interrupted Sutures
...
- Placing sutures too tight. The tissue should approximate, not strangulate. If the skin blanches, remove the suture and replace it with less tension.
- Not following the curve of the needle. A curved needle is designed to rotate through tissue in an arc. Driving it straight creates a larger, more traumatic track and bends the needle.
- Inadequate irrigation before wound closure. Closing a contaminated wound over debris produces an abscess. The solution to pollution is dilution.
- Not verifying instrument and sponge counts before and after closure. A retained surgical sponge is one of the most preventable and most consequential errors in surgery.
